class AvatarsController < ApplicationController
  ...
  def find_avatar_auth
    ...
    unless self.action_name.to_s == "show"
      if @avatar_for.downcase == "person"
        ...
        unless @avatar_for_id.to_i == current_person.id.to_i || @avatar_owner_instance.can_edit?(current_user)
        ...
        unless @avatar_owner_instance.can_edit?(current_user)
  ...
  def find_avatars
    ...
    if (@avatar_owner_instance.respond_to?(:can_edit?) && @avatar_owner_instance.can_edit?(current_user))
